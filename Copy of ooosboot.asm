...
; -----------------
kernel		equ	0x90000	; pm address of kernel
kernel_16	equ	0x9000	; rm address of kernel
...
; ------------------------------------------------------------------------
        ...
        pIDT            
			dw 7FFh         ; limit of 256 IDT slots
                        dd 0100h        ; starting at 0000

        pGDT            
			dw 17FFh        ; limit of 768 GDT slots
                        dd 0900h        ; starting at 0800h (after IDT)
...
read_me:
        ...
        ;mov si, 0       ; offset of PolyFS magic to check for (in ds)
